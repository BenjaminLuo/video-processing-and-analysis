...
class KITTI(torch.utils.data.Dataset):
    ...
    def __init__(self,
                 data_path=r"/Users/epheriami/Downloads/4B/Code/SYDE 673/P/data/sequences_jpg",
                 gt_path=r"/Users/epheriami/Downloads/4B/Code/SYDE 673/P/data/poses",
                 camera_id="2",
    ...
    def read_frames(self):
        ...
        for sequence in self.sequences:
            frames_dir = os.path.join(self.data_path, sequence, "image_{}".format(0), "*.jpg")
