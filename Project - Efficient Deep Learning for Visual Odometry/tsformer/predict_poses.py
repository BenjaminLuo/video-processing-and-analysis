...
checkpoint_path = "/Users/epheriami/Downloads/4B/Code/SYDE 673/P/tsformer/checkpoints/Exp3/global_unstruct_pruning"
checkpoint_name = "kitti_pruned_model"
...
for sequence in sequences:
    ...
    with tqdm(test_loader, unit="batch") as batchs:
        pred_poses = torch.zeros(
            (1, args["window_size"] - 1, 6), device=device)
